...
<h2><a href="dashboard.php" class="text-(--bg-btn-hover)">Home</a> / Dados vitais dos pacientes</h2>
<button id="openVitalDataModalButton" class="bg-(--bg-blue-green) p-2.5 w-3xs block cursor-pointer rounded-lg hover:bg-(--bg-blue-green-hover) duration-300 text-(--bg-baby-powder)">
    <i class="fa-solid fa-plus"></i>Cadastrar dados vitais
</button>
...
<div class="flex flex-col w-full">
    ...
    <!-- modal de cadastro de dados vitais -->
    <?php include __DIR__."/components/modal-cadastro-dados-vitas.php";?>
    </div>
