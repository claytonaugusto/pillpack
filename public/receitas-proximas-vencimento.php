    ...
    <main class="flex w-full h-screen justify-between gap-4 text-(--text-onyx)">
        ...
        <section class="w-full mr-4 ">
            ...
            <div class="flex justify-between items-center h-21 w-full mb-5">
                <h2><a href="dashboard.php" class="text-(--bg-btn-hover)">Home</a> / <a href="#" class="text-(--bg-btn-hover)">Receitas próximas ao vencimento</a></h2>
            </div>
                ...
                <div class="flex flex-col w-full h-screen">
                    ...
                    <div class="w-full mt-2.5">
                        <table>
                            ...
                            <tr>
                                <td class="error">30/03/2025</td>
                                <td>Fulano de tal ciclano beltrano</td>
                                <td>Lozartana, Amoxilina, Ritalina</td>
